...
create table t1(a number(38,2),b varchar(10));
...
select sum(ts.a)+sum(t1.a) aa from ts,t1 where ts.b>t1.b group by t1.b union select sum(a) aa from t1 where b is not null group by b order by aa;
