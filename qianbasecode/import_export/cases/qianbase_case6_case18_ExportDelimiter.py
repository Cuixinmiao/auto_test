...
def case6_18_qianbase():
    try:
        ...
        #导出        
        exportcmd = "EXPORT INTO CSV '%s' WITH delimiter = '|' FROM TABLE %s.%s;" %(localpath,newdb,tabname)
        ...
        importcmd = "use %s;IMPORT INTO %s (%s, %s) CSV DATA (%s) WITH delimiter = '|';" %(newdb,tabname,t2[2]['column_id'],t2[2]['column_balance'],importstr)
