...
def case9_qianbase():
    try:
        ...
        sonpath2 = os.path.abspath(os.path.join(basepath, "qianbasecode/import_export/PrepareTheData/simple-sorted2.json"))
        ...
        importcmd = """IMPORT INTO %s.%s AVRO DATA ('%s%s') WITH data_as_json_records,strict_validation,records_terminated_by = e'-',schema='%s';""" %(newdb,tabname,localpath,filename,schema)
        print(importcmd)
