...
def case5_16_qianbase():
    try:
        ...
        #导出        
        exportcmd = "EXPORT INTO CSV '%s/export' with compression = 'gzip'  FROM TABLE %s.%s;" %(httppath,newdb,tabname)
        a=ssh.myssh(execcmd.execcmd(exportcmd,host,dbport),ssharg)
        ...
        importcmd = "use %s;IMPORT INTO %s (%s, %s) CSV DATA (%s) with decompress = 'gzip';" %(newdb,tabname,t2[2]['column_id'],t2[2]['column_balance'],importstr)
