...
class Qianbasetest_prefault_applylayout():
    ...
    def backroom_offline_recovery_prefault_qianbase(self):
        ...
        #exec switch room op
        ret = multithread.multi_thread(info,rid,fault=1)
        if ret[0] == None:
        ...
        res = common.monitor_tpcc_runtime(p,fn=fn)
        if res != True:
    ...
    def primaryroom_offline_recovery_prefault_qianbase(self):
    ...
    def allbackroom_offline_recovery_prefault_qianbase(self):
