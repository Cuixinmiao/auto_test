...
class Qianbasetest_fault_applylayout():
    ...
    def teardown_class(self):
        #obj331.teardown()
        pass
    #@pysnooper.snoop("/home/cxm/qianbase-xtp-test/backroom_offline_fault_qianbase.log")
    def backroom_offline_recovery_fault_qianbase(self):
        ...
        #exec switch room op
        ret = multithread.multi_thread(info,rid,fault=1,fn=fn)
        if ret[0] == None:
