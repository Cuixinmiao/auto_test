...
class Qianbasetestfunc():
    ...
    def single_node_fault_init_remote_qianbase(self):
    ...
    def single_node_fault_init_localback_qianbase(self):
        # install qianbase ,set replicas 7 and register license
        startup_ha.instha()
    ...
    def single_node_fault_init_primary_qianbase(self):
        # install qianbase ,set replicas 7 and register license
        startup_ha.instha()
    ...
    def single_node_fault_init_runtime_primary_qianbase(self):
        # install qianbase ,set replicas 7 and register license
        startup_ha.instha()
    ...
    def single_node_fault_init_runtime_localback_qianbase(self):
        # install qianbase ,set replicas 7 and register license
        startup_ha.instha()
    ...
    def single_node_fault_runtime_init_remote_qianbase(self):
        ## install qianbase ,set replicas 7 and register license
        startup_ha.instha()
