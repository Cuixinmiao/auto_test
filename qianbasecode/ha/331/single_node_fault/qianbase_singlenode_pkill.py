...
class Qianbasetestfunc():
    ...
    def single_node_fault_pkill_remote_qianbase(self):
    ...
    def single_node_fault_pkill_localback_qianbase(self):
        # install qianbase ,set replicas 7 and register license
        startup_ha.instha()
    ...
    def single_node_fault_pkill_primary_qianbase(self):
        # install qianbase ,set replicas 7 and register license
        startup_ha.instha()
    ...
    def single_node_fault_pkill_runtime_primary_qianbase(self):
        # install qianbase ,set replicas 7 and register license
        startup_ha.instha()
    ...
    def single_node_fault_pkill_runtime_localback_qianbase(self):
        # install qianbase ,set replicas 7 and register license
        startup_ha.instha()
    ...
    def single_node_fault_pkill_runtime_remote_qianbase(self):
        ## install qianbase ,set replicas 7 and register license
        startup_ha.instha()
