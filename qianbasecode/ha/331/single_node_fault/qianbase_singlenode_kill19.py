...
class Qianbasetestfunc():
    ...
    def single_node_kill19_fault_remote_qianbase(self):
    ...
    def single_node_fault_kill19_localback_qianbase(self):
        # install qianbase ,set replicas 7 and register license
        startup_ha.instha()
    ...
    def single_node_fault_kill19_primary_qianbase(self):
        # install qianbase ,set replicas 7 and register license
        startup_ha.instha()
    ...
    def single_node_fault_kill19_runtime_primary_qianbase(self):
        # install qianbase ,set replicas 7 and register license
        startup_ha.instha()
    ...
    def single_node_fault_kill19_runtime_localback_qianbase(self):
        # install qianbase ,set replicas 7 and register license
        startup_ha.instha()
    ...
    def single_node_fault_kill19_runtime_remote_qianbase(self):
        ## install qianbase ,set replicas 7 and register license
        startup_ha.instha()
